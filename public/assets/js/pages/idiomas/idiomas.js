...
$(function() {
    ...
    $("#frmarchivo").validate();
    $(".editar_archivo").on("click",function(e) {
        e.preventDefault();
        let id_adrchivo = parseInt($(this).attr('id').replace("archivo_",""));
    ...
    $("#btn_edit").on("click",function(e) {
        ...
        $.ajax({
            ...
            data: {
                id:id,
                idioma : $("[name='idioma']").val(),
                abreviatura : $("[name='abreviatura']").val(),
    ...
    $(".eliminar_idioma").on("click",function(e) {
        e.preventDefault();
